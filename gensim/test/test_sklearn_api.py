...
class TestLdaWrapper(unittest.TestCase):
    ...
    def testPipeline(self):
        ...
        text_lda = NewPipeline([('features', model,), ('classifier', clf)])
...
class TestLsiWrapper(unittest.TestCase):
    ...
    def testPipeline(self):
        ...
        numpy.random.mtrand.RandomState(1)  # set seed for getting same result
        clf = linear_model.LogisticRegression(penalty='l2', C=0.1)
        text_lsi = NewPipeline([('features', model,), ('classifier', clf)])
...
class TestLdaSeqWrapper(unittest.TestCase):
    ...
    def testPipeline(self):
        ...
        clf = linear_model.LogisticRegression(penalty='l2', C=0.1)
        text_ldaseq = NewPipeline([('features', model,), ('classifier', clf)])
...
class TestRpWrapper(unittest.TestCase):
    ...
    def testPipeline(self):
        ...
        numpy.random.mtrand.RandomState(1)  # set seed for getting same result
        clf = linear_model.LogisticRegression(penalty='l2', C=0.1)
        text_rp = NewPipeline([('features', model,), ('classifier', clf)])
...
class TestWord2VecWrapper(unittest.TestCase):
    ...
    def testPipeline(self):
        ...
        text_w2v = NewPipeline([('features', model,), ('classifier', clf)])
...
class TestAuthorTopicWrapper(unittest.TestCase):
    ...
    def testPipeline(self):
        ...
        text_atm = NewPipeline([('features', model,), ('cluster', clstr)])
...
class TestText2BowTransformer(unittest.TestCase):
    ...
    def testPipeline(self):
        ...
        numpy.random.mtrand.RandomState(1)  # set seed for getting same result
        clf = linear_model.LogisticRegression(penalty='l2', C=0.1)
        text_lda = NewPipeline([('bow_model', text2bow_model), ('ldamodel', lda_model), ('classifier', clf)])
...
class TestTfIdfTransformer(unittest.TestCase):
    ...
    def testPipeline(self):
        ...
        numpy.random.mtrand.RandomState(1)  # set seed for getting same result
        clf = linear_model.LogisticRegression(penalty='l2', C=0.1)
        text_tfidf = NewPipeline([('tfidf_model', tfidf_model), ('ldamodel', lda_model), ('classifier', clf)])
...
class TestFastTextWrapper(unittest.TestCase):
    ...
    def testPipeline(self):
        ...
        clf = linear_model.LogisticRegression(penalty='l2', C=0.1)
        clf.fit(model.transform(train_input), train_target)
        text_ft = NewPipeline([('features', model,), ('classifier', clf)])
